...
> check's precondition does not hold, it declines to vote. One that fires on "I cannot tell" turns every
...
[`docs/RECONCILE.md`](docs/RECONCILE.md) compares signed agreements against
what a collateral system holds, read-only;
